...
parser.add_argument("--file_name", type=str, default="mri/", help="saving directory")
...
# forward operator
parser.add_argument('--A_type', type=str, default="MRI", help="I, Gaussian, DCT, cs")
parser.add_argument('--s', type=float, default=0.5, help="compressed sensing compression")
parser.add_argument('--Gauss_var', type=float, default=0.1, help="gaussian var in A")
...
net = nets.MRI_gd(forward_op, dncnn, args).to(args.device) # SGD jitter noise added in net
